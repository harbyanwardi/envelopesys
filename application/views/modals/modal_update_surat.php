<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <form id="form-update-surat" method="POST" enctype="multipart/form-data">
    ...
    <div class="input-group form-group">
     ...
     <select name="ket_diterima" value="<?php echo $dataSurat->tanggal_pengembalian_tanda; ?>" class="selectpicker show-tick form-control" data-live-search="true" title="Pilih Kategori" data-width="80%" placeholder="Pilih Kategori" required>
